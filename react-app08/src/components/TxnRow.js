...
import { createDelTxnAction,createMarkTxnEditAction } from '../state/actions';
...
const mapDispatchToProps = dispatch => ({
    delItem: id => dispatch(createDelTxnAction(id)),
    editItem: id => dispatch(createMarkTxnEditAction(id))
});
