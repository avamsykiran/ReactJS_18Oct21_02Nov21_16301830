...
import { createAddTxnAction,createModTxnAction,createUnMarkTxnEditAction } from '../state/actions';

const TxnForm = ({ txnToEdit, addTxn,updateTxn,cancelEdit }) => {
                    ...
                    (
                        <div className="col-3">
                            ...
                            <button className="btn btn-danger btn-sm" type="button"
                                onClick={e => cancelEdit(txn.id)}>Cancel</button>
                        </div>
                    ) : (
                        <div className="col-3">
...
const mapDispatchToProps = dispatch => ({
    ...
    updateTxn: txn => dispatch(createModTxnAction(txn)),
    cancelEdit: id => dispatch(createUnMarkTxnEditAction(id))
});
